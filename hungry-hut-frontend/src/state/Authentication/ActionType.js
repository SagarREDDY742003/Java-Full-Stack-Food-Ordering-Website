// The Action Type is a string constant that identifies the kind of action being performed.
// It helps reducers determine how to update the state.
// Best Practice: Use constants to avoid typos.
